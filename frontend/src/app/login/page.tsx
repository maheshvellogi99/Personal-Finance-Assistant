...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!showMfa && !googleAccessToken && (!email || !password)) {
    ...
    try {
      if (showMfa && googleAccessToken) {
        ...
        const success = await login(email, password, showMfa ? totpCode : undefined);
        if (success) {
          router.push('/');
        }
      }
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative z-10">
        ...
        >
          <h2 className={`${playfair.className} text-2xl font-semibold text-white tracking-wide mb-6 text-center`}>
            {showMfa ? 'Verification' : 'Welcome Back'}
          </h2>
            ...
            <div className="bg-rose-500/10 border-l-4 border-rose-500 p-3.5 rounded mb-5">
              <div className="flex">
                ...
                <div className="ml-2.5">
                  <p className="text-[10px] font-bold text-rose-400 uppercase tracking-widest">Security Exception</p>
              ...
              <>
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <a href="#" className="text-[10px] text-blue-400 hover:text-blue-300 transition-colors">Forgot password?</a>
                  </div>
                  <input
                    type="password"
                    required
          ...
          {!showMfa && (
            <div className="mt-6 pt-5 border-t border-white/[0.06] text-center">
              <span className="text-xs text-neutral-500">New to AWS Finance?</span>{' '}
              <Link
                href="/register"
